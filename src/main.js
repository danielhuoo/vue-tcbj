...
import 'src/components/weui.css'
//引用自定义组件
import $message from 'src/components/alert'
// import $confirm from 't/components/confirm'
import loadingObj from 'src/components/loading'
//引入配置文件
